...
namespace eCommerce.OrdersMicroservice.DataAccessLayer
{
    public static class DependencyInjection
    {
        public static IServiceCollection AddDataAccessLayer(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            //The meaning of below code is that we are registering the IMongoClient as a singleton service in the DI container because we want to use the same instance of IMongoClient throughout the application.
